...
class PeminjamanItemListPage extends StatelessWidget {
  ...
  void _navigateToRoleDashboard(BuildContext context) {
    final targetPage = _isSpv ? const SpvLandingPage() : const StaffLandingPage();
  ...
  Widget build(BuildContext context) {
    ...
    final items = <BorrowItemData>[
      const BorrowItemData(
        ...
        availableCount: 4,
        imageUrl: 'https://www.figma.com/api/mcp/asset/98963021-41f9-494e-b719-9fe028b772da',
      ),
      const BorrowItemData(
        brand: 'SONY',
        ...
        availableCount: 2,
        imageUrl: 'https://www.figma.com/api/mcp/asset/ab9c5259-26cd-4f7d-81b4-b66b169e5ae9',
      ),
      const BorrowItemData(
        brand: 'APPLE',
        name: 'iPad Pro 12.9"',
        ...
        availableCount: 6,
        imageUrl: 'https://www.figma.com/api/mcp/asset/2de7bd5e-34b5-4145-b78a-e66795e2d307',
      ),
      const BorrowItemData(
        brand: 'EPSON',
        ...
        availableCount: 1,
        imageUrl: 'https://www.figma.com/api/mcp/asset/270f7bbf-1ee1-4a1f-9f53-1c6855cb3641',
      ),
    ];
                  ...
                  return _InventoryCard(
                    ...
                    onRequestBorrow: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (_) => PengajuanItemPage(item: items[index]),
                        ),
                      );
                    },
                  );
        ...
        children: [
          ...
          if (isStaff) ...[
            ...
            SizedBox(
              width: double.infinity,
              height: 48,
              child: _AnimatedRequestButton(
                onPressed: onRequestBorrow,
              ),
            ),
          ],
        ],
    ...
    return GestureDetector(
      ...
      child: AnimatedScale(
        ...
        child: AnimatedContainer(
          ...
          curve: Curves.easeOut,
          decoration: BoxDecoration(
            color: _isPressed ? const Color(0xFFD9E9FF) : const Color(0xFFEFF6FF),
            borderRadius: BorderRadius.circular(14),
