    ...
    return RefreshIndicator(
      ...
      child: ListView(
        ...
        children: [
          ...
          // Pengembalian material baru dibuka setelah status WO mencapai tahap
          // akhir ("Selesai" — progress staf sudah diverifikasi SPV — atau
          // "Tutup"). Selama status masih "Proses" pekerjaan (dan materialnya)
          // masih berjalan, jadi tombol disembunyikan meski entri progress
