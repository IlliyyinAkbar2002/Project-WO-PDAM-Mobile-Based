...
class FormKembaliMaterialPage extends StatefulWidget {
  ...
  @override
  State<FormKembaliMaterialPage> createState() => _FormKembaliMaterialPageState();
}

class _FormKembaliMaterialPageState extends AppStatePage<FormKembaliMaterialPage> {
  ...
  void initState() {
    super.initState();
    final sisaDipinjam = (widget.peminjaman.jumlahPinjam ?? 0) - (widget.peminjaman.jumlahKembali ?? 0);
    ...
    if (_formKey.currentState!.validate()) {
      context.read<MaterialBloc>().add(
            KembalikanMaterialEvent(
              ...
              kondisiKembali: _kondisiController.text.isNotEmpty ? _kondisiController.text : null,
            ),
          );
