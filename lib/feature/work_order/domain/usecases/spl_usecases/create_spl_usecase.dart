...
class CreateSplUseCase
    implements UseCase<Future<DataState<SplEntity>>, Map<String, dynamic>> {
  final SplRepository repository;

  CreateSplUseCase(this.repository);

  @override
  Future<DataState<SplEntity>> call(Map<String, dynamic> payload) {
    return repository.createSpl(payload);
  }
}
