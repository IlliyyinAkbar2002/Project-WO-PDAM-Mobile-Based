...
class PinjamMaterial implements UseCase<Future<DataState<PeminjamanMaterialEntity>>, PinjamMaterialParams> {
  final MaterialRepository _repository;
  PinjamMaterial(this._repository);

  @override
  Future<DataState<PeminjamanMaterialEntity>> call(PinjamMaterialParams params) {
