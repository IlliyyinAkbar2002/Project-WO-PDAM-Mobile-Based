...
class _FormPinjamMaterialPageState
    extends AppStatePage<FormPinjamMaterialPage> {
          ...
          children: [
            ...
            BlocBuilder<MaterialBloc, MaterialState>(
              buildWhen: (previous, current) =>
                  current is MasterMaterialsLoaded ||
                  ...
                  return DropdownButtonFormField<MaterialEntity>(
                    ...
                    items: materials.map((m) {
                      return DropdownMenuItem(
                        value: m,
                        child: Text(
                          '${m.namaMaterial} (Sisa: ${m.stokTersedia})',
                        ),
                      );
                    }).toList(),
                    onChanged: (val) {
            ...
            TextFormField(
              ...
              validator: (value) {
                ...
                if (_selectedMaterial != null &&
                    val > _selectedMaterial!.stokTersedia) {
